...
su - eai -c 'ssh-keygen -t ed25519 -C "ansible"'
su - eai -c 'ssh-copy-id -i ~/.ssh/id_ed25519.pub eai@172.16.16.100'
su - eai -c 'ssh-copy-id -i ~/.ssh/id_ed25519.pub eai@172.16.16.101'
su - eai -c 'ssh-copy-id -i ~/.ssh/id_ed25519.pub eai@172.16.16.102'
...
echo "SSH key generation, copying, shared folder creation, and mounting completed."